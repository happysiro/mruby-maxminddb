...
static mrb_value mrb_maxminddb_hello(mrb_state *mrb, mrb_value self)
{
...
static mrb_value mrb_maxminddb_hi(mrb_state *mrb, mrb_value self)
{
  return mrb_str_new_cstr(mrb, "hoge!!");
}
...
void mrb_mruby_maxminddb_gem_init(mrb_state *mrb)
{
    ...
    mrb_define_method(mrb, maxminddb, "hello", mrb_maxminddb_hello, MRB_ARGS_NONE());
    mrb_define_class_method(mrb, maxminddb, "hi", mrb_maxminddb_hi, MRB_ARGS_NONE());
    DONE;
}
